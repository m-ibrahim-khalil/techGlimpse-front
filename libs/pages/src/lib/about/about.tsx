  ...
  return (
    <div className="container mx-auto px-4 py-3">
      <p className="my-10 text-gray-500 dark:text-gray-400 first-line:uppercase first-line:tracking-widest first-letter:text-7xl first-letter:font-bold first-letter:text-gray-900 dark:first-letter:text-gray-100 first-letter:mr-3 first-letter:float-left">
        TechGlimpse - Your Window to the World of Technology! Whether you're an
        avid tech enthusiast, a curious learner, or a seasoned professional,
        TechGlimpse is your one-stop destination for all the latest updates,
        trends, and innovations in the tech realm.
      </p>
      <h3 className="text-3xl font-bold dark:text-white mt-10">Introduction</h3>
      <p className="text-gray-500 dark:text-gray-400">
        ...
        aspiring techie, or simply someone curious about the latest advancements
        in the digital realm, you've come to the right place.
      </p>
      <h3 className="text-3xl font-bold dark:text-white mt-10">Mission</h3>
      ...
      <h3 className="text-3xl font-bold dark:text-white mt-10">Vission</h3>
      <p className="text-gray-500 dark:text-gray-400">
      ...
      <h3 className="text-3xl font-bold dark:text-white mt-10">
        Join the TechGlimpse Community Today!
      </h3>
      <p className="text-gray-500 dark:text-gray-400">
        Whether you're a tech newbie or a seasoned professional, TechGlimpse has
        something for everyone. Join us on this exhilarating journey through the
        world of technology. Subscribe to our newsletter, follow us on social
        media, and become part of the TechGlimpse community to embark on an
        enriching tech experience. Thank you for being a part of TechGlimpse!
